...
export function HeroHeader() {
    ...
    return (
        <div className="hidden md:block w-full px-8 min-[400px]:px-8 md:px-12 lg:px-20 mx-auto border-b border-border/50 pb-20 md:py-32">
            <div className="flex flex-col items-center justify-center relative gap-8 md:gap-12">
                <div className="flex flex-col items-center justify-center">
                    <motion.span
                        ...
                        className="text-[10px] md:text-sm font-bold tracking-[1.2em] md:tracking-[1.5em] uppercase mb-4 md:mb-6"
                    >
                    ...
                    <div className="flex items-center justify-center gap-6 md:gap-10">
                        ...
                        <BlurText
                            ...
                            animateBy="words"
                            direction="top"
                            className="text-3xl md:text-5xl lg:text-[6rem] font-light tracking-tighter leading-none"
                        />
                        <div className="w-1 h-1 bg-brand rotate-45 hidden md:block" />
                    </div>
                </div>
